...
ros2 run crazyflie_vicon_bringup single_drone_streamed_hover
ros2 run crazyflie_vicon_bringup cf5_position_exchange
ros2 run crazyflie_vicon_bringup eight_drone_position_exchange
```
...
- `cf5_position_exchange` expects only `cf5` active from `bringup_single_streamed_hover.launch.py`.
- `eight_drone_position_exchange` expects all eight drones active from `bringup_8.launch.py`.
